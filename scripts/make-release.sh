...
for x in app scripts tests Dockerfile requirements.txt VERSION compose.yaml install.sh README.md CHANGELOG.md .dockerignore .env.example; do cp -a "$ROOT/$x" "$TMP/$NAME/"; done
